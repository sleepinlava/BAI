...
contig-level gate and is excluded from the canonical claim table; the current v2 evidence uses an
independent K127 assembly, both coverage gates, duplicate-prediction penalty, machine-evidence
manifest, and figure provenance. Because the paper-specific 13,469-record PLSDB deduplication list is
