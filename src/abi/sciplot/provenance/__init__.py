...
def write_provenance(
    ...
    record: Dict[str, Any] = {
        ...
        "source_run_id": spec.provenance.source_run_id or "unknown",
        "source_standard_table": spec.provenance.source_standard_table or "unknown",
        "source_standard_table_sha256": (spec.provenance.source_standard_table_sha256 or "unknown"),
